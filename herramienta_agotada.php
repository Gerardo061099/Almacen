                    ...
                    <table class="table table-striped table-dark">
                        ...
                        ?>
                            <tbody class="body-tb">
                                <tr>
                                    <td>
                                        <center><?php echo $consulta['id_herramienta'] ?></center>
                                    </td>
                                    <td>
                                        <center><?php echo $consulta['Nombre'] ?></center>
                                    </td>
                                    <td><?php echo $consulta['material'] ?></td>
                                    <td><?php echo $consulta['descripcion'] ?></td>
                                    <td>
                                        <center><?php echo $consulta['Num_gavilanes'] ?></center>
                                    </td>
                                    <td>
                                        <center><?php echo $consulta['Ancho'] ?></center>
                                    </td>
                                    <td>
                                        <center><?php echo $consulta['Largo'] ?></center>
                                    </td>
                                    <td>
                                        <center><?php echo $consulta['cantidad'] ?></center>
                                    </td>
                                    <td>
                                        <center><?php echo $consulta['cantidad_minima'] - $consulta['cantidad'] ?></center>
                                    </td>
                                </tr>
                            </tbody>
                        <?php
